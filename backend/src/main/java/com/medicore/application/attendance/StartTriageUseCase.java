...
public class StartTriageUseCase {
    ...
    @Transactional
    public AttendanceResponse execute(UUID attendanceId, StartTriageCommand command) {
        ...
        attendance.startTriage(command.nurseId(), fallbackActor(command.requestedBy(), "Enfermagem"));
